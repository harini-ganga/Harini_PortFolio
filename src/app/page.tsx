          ...
          <div className="animate-fadeIn">
            <div className="mb-8">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <a href="https://linkedin.com/in/harini-g" className="group bg-gray-800/50 border border-green-500/30 rounded-lg p-4 hover:bg-green-500/5 hover:border-green-400 transition-all duration-300 transform hover:-translate-y-1">
                  <div className="flex items-center">
